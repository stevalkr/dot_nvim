  ...
  opts = function()
    ...
    return {
      ...
      on_attach = function(bufnr)
        ...
        utils.keymap('n', '<leader>hB', function()
          gitsigns.blame_line({ full = true })
        end, 'Blame line', kopts)
        utils.keymap(
          'n',
          '<leader>hb',
        ...
        utils.keymap('n', '<leader>hD', function()
          gitsigns.diffthis('~')
        end, 'Diff this HEAD', kopts)
        utils.keymap(
          'n',
          '<leader>ht',
